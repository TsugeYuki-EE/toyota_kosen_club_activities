...
const DEFAULT_TIMER_PRESETS: TimerPreset[] = [
  { id: "timer-system-break-120", label: "休憩2分", durationSeconds: 120, description: "短い休憩", isSystemPreset: true },
  { id: "timer-system-interval-120-6", label: "2:00 × 6セット", durationSeconds: 120, setCount: 6, description: "2分の反復練習", isSystemPreset: true },
  { id: "timer-system-interval-150-6", label: "2:30 × 6セット", durationSeconds: 150, setCount: 6, description: "少し長めの反復練習", isSystemPreset: true },
];
